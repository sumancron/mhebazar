  ...
  return (
    <footer className="bg-white border-t">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center gap-6">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">
              Subscribe &amp; Get <span className="text-yellow-400">10% Discount</span>
            </h2>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        {/* Address & Contact */}
        <div>
          <img src="/mhe-logo.png" alt="MHE Bazar" className="mb-4 w-24" />
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li><a href="#" className="hover:text-blue-700 transition">Used MHE</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">MHE Rental</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">CMC & AMC Services</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Training</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Testimonials</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Contact Us</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Vendors</a></li>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            <li><a href="#" className="hover:text-blue-700 transition">Help Center</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Live chat</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Check order status</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Refunds</a></li>
            <li><a href="#" className="hover:text-blue-700 transition">Report abuse</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="bg-gray-50 border-t py-6">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-8 text-center text-sm">
          <div className="flex flex-col items-center min-w-[120px] mb-4 sm:mb-0">
            ...
            <span className="text-xs text-gray-500">MHEBazar delivers products globally.</span>
          </div>
          <div className="flex flex-col items-center min-w-[120px] mb-4 sm:mb-0">
            <Headphones className="w-7 h-7 mb-2 text-blue-700" />
            <span className="font-semibold">Support 24/7</span>
            <span className="text-xs text-gray-500">Reach our experts today!</span>
          </div>
          <div className="flex flex-col items-center min-w-[120px] mb-4 sm:mb-0">
          ...
          <div className="flex flex-col items-center min-w-[120px] mb-4 sm:mb-0">
            ...
            <span className="text-xs text-gray-500">Read our return policy</span>
          </div>
