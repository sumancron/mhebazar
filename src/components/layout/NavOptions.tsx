            ...
            <div className="w-64 bg-gray-50 border-r border-gray-200">
              <div className="p-2">
                {categories.map((category, index) => (
                  <div
                    key={index}
                    className={`flex items-center justify-between px-3 py-2 text-sm hover:bg-white hover:text-orange-600 cursor-pointer rounded transition-colors ${category === "Battery" ? "bg-white text-orange-600 font-medium" : "text-gray-700"
                      }`}
                  >
                    <span>{category}</span>
